...
def safe_linprog(c, A_ub=None, b_ub=None, A_eq=None, b_eq=None, bounds=None):
    """
    ...
    try:
        ...
        raise ImportError("scipy.optimize.linprog requires scipy library. Install with: pip install scipy")
